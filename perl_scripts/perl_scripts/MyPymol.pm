...
sub util_PrintPymolSingleProtein{
    my ($ofh,$pdb1,$list1,$list2,$infile,$imagenm) = @_ ; 
    ...
    # print $ofh "color purple, ss h \n";
    # print $ofh "color yellow, ss s \n";
    # print $ofh "color grey, ss \"\" \n";
    
    print $ofh "#color carbon, chain A \n";
