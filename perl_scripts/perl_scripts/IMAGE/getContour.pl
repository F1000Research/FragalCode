...
sub ProcessInfo{
	...
	my ($minX,$minY,$maxY,$maxX,$CminX,$CminY,$CmaxY,$CmaxX,$midX,$midY,$AREACALCBYPIXEL,$insidetable,@allpoints) = $image->GetAllPoints($listF,$listR);
	...
	foreach my $PPP (1..4){
		...
		my $requiredDividingration = $PPP/5 ;
